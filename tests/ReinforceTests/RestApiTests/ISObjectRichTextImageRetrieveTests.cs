...
namespace ReinforceTests.RestApiTests
{
    public class ISObjectRichTextImageRetrieveTests
    {
        ...
        )
        {
            ...
            await api.GetAsync(sObjectName, id, fieldName, contentReferenceId, CancellationToken.None, "v56.0");
            handler.ConfirmPath($"/services/data/v56.0/sobjects/{sObjectName}/{id}/richTextImageFields/{fieldName}/{contentReferenceId}");
        }
    }
}